...
void display()
{
    ...
    if (value == -1)
    {
        ...
        char cn[] = "Sapthagiri College of Engineering";
        drawhead(-490, 900, 0, cn);
        char pn[] = "#14/5, Chikkasandra, Hesaraghatta Main Road, Bangalore – 560057";
        drawsubhead(-550, 850, 0, pn);

        char dn[] = "Department of Computer Science & Engineering";
        drawhead(-650, 650, 0, dn);
        char prn[] = "Computer Graphics Laboratory with Mini Project [ 18CSL67 ]";
        drawsubhead(-525, 450, 0, prn);
        char pro[] = "Topic: ATOM SIMULATION";
        drawhead(-450, 350, 0, pro);
        char pb[] = "PROJECT BY: ";
        drawhead(-690, -150, 0, pb);
        char p1[] = "Pranav Parth";
        ...
        char g1[] = "Prof. S. Suresh Kumar";
        drawhead(290, -250, 0, g1);
        char d1[] = "Assistant Professor, Dept. Of CSE, SCE";
        drawsubhead(290, -300, 0, d1);
        char g2[] = "Prof. Anuradha Badage";
        drawhead(290, -400, 0, g2);
        char d2[] = "Assistant Professor, Dept. of CSE, SCE";
